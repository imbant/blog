...
- HTML
  ...
  - 语义化标签
    ...
    ![](https://imbant-blog.oss-cn-shanghai.aliyuncs.com/blog-img/2/2020-%E5%BA%94%E8%81%98.gif)
...
#### 不定参数函数的语法，手写。在 es6 之前没有这种语法，怎么解决（arguments？）
#### js 的数值
#### 正则
...
### HTML
1. meta 标签是啥。引申打开 tatter.com 前10行 HTML 标签是干嘛的
2. shadow dom、web component
...
1. 用到 TS 的项目可以问一些 ts 方面的东西
2. 用到 SSR 的项目，可以问一下相关内容
3. 如果有 node 相关的可以问一些偏后端的问题